...
static void expand (u32int, heap_t *);
static u32int contract (u32int, heap_t *);
static s32int find_smallest_hole (u32int, u8int, heap_t *);
static s8int header_t_less_than (void *, void *);
